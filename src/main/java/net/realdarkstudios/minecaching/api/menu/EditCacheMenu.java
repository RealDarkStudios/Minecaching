...
public class EditCacheMenu extends MCMenu {
    ...
    public EditCacheMenu(Minecache cache, PlayerDataObject author, JavaPlugin plugin) {
        super("Editing Cache", MenuSize.FOUR_ROW, plugin);
        this.author = author;
        this.cache = cache;
    ...
    public void update(Player player) {
        ...
        setItem(27, new OpenConfirmationMenuItem(new DeleteCacheMenuItem("Delete", new ItemStack(Material.BLACK_CONCRETE), cache, "This WILL delete this cache FOREVER!"), this));
