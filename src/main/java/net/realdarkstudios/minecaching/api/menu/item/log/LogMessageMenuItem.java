...
public class LogMessageMenuItem extends MenuItem {
    ...
    public void onItemClick(MenuItemClickEvent event) {
        ...
        TextComponent msg = TextComponentBuilder.fromTranslation("logcache.menu.message").color(ChatColor.LIGHT_PURPLE).underline().clickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/log message " + pdo.getLogMessage()).build();
